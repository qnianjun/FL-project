...
Five clients, 10 rounds, one local epoch, SGD learning rate 0.01, batch size 32, MNIST, alpha 0.1, client 0 update scale 10. Seeds: 42, 43, 44.

| Seed | Clean final accuracy | Poisoned final accuracy | Drop (percentage points) |
| --- | --- | --- | --- |
| 42 | 87.50% | 31.18% | 56.32 |
| 43 | 85.33% | 85.37% | -0.04 |
| 44 | 75.77% | 29.39% | 46.38 |
