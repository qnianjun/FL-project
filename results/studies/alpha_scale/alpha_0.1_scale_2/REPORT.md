...
Five clients, 10 rounds, one local epoch, SGD learning rate 0.01, batch size 32, MNIST, alpha 0.1, client 0 update scale 2. Seeds: 42, 43, 44.
...
- Poisoned mean ± sample SD: **81.58% ± 5.95 percentage points**.
- Paired accuracy drop: **1.28 ± 1.50 percentage points**.
...
- Poisoned final loss: **0.5608 ± 0.1606**.
- Paired loss damage: **0.0335 ± 0.0402**.
...
```bash
.venv/bin/python run_matched.py --alpha 0.1 --scale 2 --seeds 42 43 44 --rounds 10 --output results/experiments/NEW_RUN
