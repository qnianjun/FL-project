...
Five clients, 10 rounds, one local epoch, SGD learning rate 0.01, batch size 32, MNIST, alpha 0.1, client 0 update scale 5. Seeds: 42, 43, 44.
...
- Poisoned mean ± sample SD: **77.87% ± 8.81 percentage points**.
- Paired accuracy drop: **5.00 ± 4.45 percentage points**.
...
- Poisoned final loss: **0.6643 ± 0.2572**.
- Paired loss damage: **0.1370 ± 0.1435**.
...
```bash
.venv/bin/python run_matched.py --alpha 0.1 --scale 5 --seeds 42 43 44 --rounds 10 --output results/experiments/NEW_RUN
