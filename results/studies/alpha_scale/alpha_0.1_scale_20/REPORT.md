...
Five clients, 10 rounds, one local epoch, SGD learning rate 0.01, batch size 32, MNIST, alpha 0.1, client 0 update scale 20. Seeds: 42, 43, 44.

| Seed | Clean final accuracy | Poisoned final accuracy | Drop (percentage points) |
| --- | --- | --- | --- |
| 42 | 87.50% | 11.35% | 76.15 |
| 43 | 85.33% | 84.85% | 0.48 |
| 44 | 75.77% | 32.25% | 43.52 |

- Clean mean ± sample SD: **82.87% ± 6.24 percentage points**.
- Poisoned mean ± sample SD: **42.82% ± 37.87 percentage points**.
- Paired accuracy drop: **40.05 ± 37.95 percentage points**.
...
- Poisoned final loss: **22.8970 ± 27.5081**.
- Paired loss damage: **22.3696 ± 27.5439**.
...
```bash
.venv/bin/python run_matched.py --alpha 0.1 --scale 20 --seeds 42 43 44 --rounds 10 --output results/experiments/NEW_RUN
